...
module Data.Reflection.Serialiser.Serialisable (Serialisable (..), serialise) where

import Data.ByteString (ByteString, toStrict)
import Data.ByteString.Builder (Builder, toLazyByteString)
import Data.Reflection.Serialiser.FieldName (FieldName)
...
--
-- The 'Data.Reflection.Serialiser.Compiler' will generate an instance of that typeclass for the given format and object
